...
public class Ui {
    public Choice menu(){
        Choice returnChoice;
        System.out.println("0. Exit" + " 1. Add something to the process" + "  2.Remove something from the process" + " 3. Display the process" + " 4.Save the process " + " 5.Load the process "  );
        int choice;
